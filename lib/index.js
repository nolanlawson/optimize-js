  ...
  function handleFunctionExpression (node) {
    ...
    function isProbablyBrowserifyModule (node) {
      return isElementOfArray(node) &&
        ...
        node.parentNode.parentNode.parentNode && // function call expression
        node.parentNode.parentNode.parentNode.callee && // function that is being called
        node.parentNode.parentNode.parentNode.callee.type === 'FunctionExpression'
    }
